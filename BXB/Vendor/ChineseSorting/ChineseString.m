...
//            NSLog(@"chineseString.string== %@",chineseString.string);
    ...
    [chineseStringsArray sortUsingComparator:^NSComparisonResult(ChineseString * _Nonnull obj1, ChineseString * _Nonnull obj2) {
        return [obj1.pinYin containsString:@"#"] && ![obj2.pinYin containsString:@"#"];
    }];
