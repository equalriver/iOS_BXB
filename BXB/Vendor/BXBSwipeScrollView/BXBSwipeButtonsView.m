...
#import "BXBSwipeButtonsView.h"
#import "SWUtilityButtonTapGestureRecognizer.h"

@interface BXBSwipeButtonsView()
...
@implementation BXBSwipeButtonsView
...
- (void)layoutSubviews {
    ...
    if (_utilityButtons.count)
    {
        for (int i = 0; i < _utilityButtons.count; i++) {
            
            UIButton *b = _utilityButtons[i];
            b.frame = CGRectMake(kBXBSwipeButtonWidthDefault * i, 0, kBXBSwipeButtonWidthDefault, self.bounds.size.height);
...
- (void)setUtilityButtons:(NSArray *)utilityButtons
{
    ...
    [self setUtilityButtons:utilityButtons WithButtonWidth:kBXBSwipeButtonWidthDefault];
}
